...
import 'package:administration_course/pages/transaksi_masuk/transaksi_masuk_list_page.dart';
...
class TransaksiMasukPage extends StatefulWidget {
  static const routeName = '/transaksi_masuk';
  const TransaksiMasukPage({Key? key}) : super(key: key);

  @override
  State<TransaksiMasukPage> createState() => _TransaksiMasukPageState();
}
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.of(context).pushNamed(TransaksiMasukAddFormPage.routeName,
              arguments: TransaksiKasMasuk(
                  idTransaksiKasMasuk: '',
                  tanggal: '',
                  idJenisKasMasuk: '',
                  idSiswa: '',
                      ...
                      TextButton(
                        ...
                        onPressed: () {
                          Navigator.of(context)
                              .pushNamed(TransaksiMasukListPage.routeName);
                        },
                        child: Row(
                          children: [
                            Text(
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        return Slidable(
                  ...
                  slidable?.dismiss(
                    ResizeRequest(const Duration(milliseconds: 300), () {
                      ...
                      confirmPopUp(
                          context,
                          "delete_kas_masuk",
                          listTransaksi[index].idTransaksiKasMasuk,
                          "Hapus",
          ...
          child: TransItemTile(
            transactionIn: listTransaksi[index],
