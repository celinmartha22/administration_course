...
/// Data tambahan atau ramngkuman dari grafik chart [Medium Screen]
class RevenueSectionMedium extends StatelessWidget {
  const RevenueSectionMedium({Key? key}) : super(key: key);
